...
public class EmptyFormController {
    ...
    @Operation(
            summary = "Get empty form or created form by Id",
            description = "Pass empty form id and it will return an empty form")
            @ApiResponses(value = {
    ...
    @Operation(
            summary = "Get all empty forms",
            description = "This endpoint returns the complete list of empty forms")
            @ApiResponses(value = {
    ...
    @Operation(
            summary = "Save new created empty form",
            description = "Pass the AdminId and new created empty form data in Json format and it will save it into database")
            @ApiResponses(value = {
    ...
    @Operation(
            summary = "Update empty form by empty form id",
            description = "Pass empty form id and the edited or redesigned empty form as Json format and it will updated into database")
            @ApiResponses(value = {
    ...
    @Operation(
            summary = "Delete empty form by id",
            description = "Pass the empty form id and it will remove it from database")
            @ApiResponses(value = {
    ...
    @Operation(
            summary = "Get related empty forms created by specific admin",
            description = "Pass the AdminId and it will return list of forms created by that respected admin")
            @ApiResponses(value = {

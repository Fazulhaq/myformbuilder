...
public class UserDataController {
    ...
    @Operation(
            ...
            description = "Pass the user id and it will return that specific user data from database")
            @ApiResponses(value = {
    ...
    @Operation(
            ...
            description = "Call this endpoint and it will return all the existing users in the database even they are admins or consumers")
            @ApiResponses(value = {
    ...
    @Operation(
            summary = "Save new user to the database",
            description = "Send the new user data in Json format to this endpoint and it will save it to database")
            @ApiResponses(value = {
    ...
    @Operation(
            ...
            description = "For updating a user data, send edited user data in Json format with related user id to be updated in database")
            @ApiResponses(value = {
    ...
    @Operation(
            ...
            description = "Pass the user id to this endpoint and it will remove it from database")
            @ApiResponses(value = {
